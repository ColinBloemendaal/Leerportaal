...
<template>
    <Link href="/admin/reseller/assignments" class="d-inline-block mb-3">{{
        t('admin.reseller.assignments.back')
    }}</Link>
    ...
    <div class="btn-group mb-4" role="group">
        ...
        <button
            type="button"
            class="btn"
            :class="mode === 'bulk' ? 'btn-primary' : 'btn-outline-primary'"
            @click="mode = 'bulk'"
        >
        ...
        <button
            type="button"
            class="btn"
            :class="mode === 'group' ? 'btn-primary' : 'btn-outline-primary'"
            @click="mode = 'group'"
        >
    ...
    <form v-if="mode === 'individual'" class="col-md-6" @submit.prevent="submit">
        <div class="mb-3">
            ...
            <div v-if="individualForm.errors.course_id" class="invalid-feedback">
                {{ individualForm.errors.course_id }}
            </div>
        </div>
        <div class="mb-3">
            ...
            >
                ...
                <option v-for="cursist in cursisten.data" :key="cursist.id" :value="cursist.id">
                    {{ cursist.name }}
                </option>
            </select>
    ...
    <form v-else-if="mode === 'bulk'" class="col-md-6" @submit.prevent="submit">
        <div class="mb-3">
            ...
            <select
                ...
                class="form-select"
                :class="{ 'is-invalid': bulkForm.errors.course_id }"
            >
                <option value="" disabled>{{ t('admin.reseller.assignments.selectCourse') }}</option>
                <option v-for="course in courses.data" :key="course.id" :value="course.id">{{ course.title }}</option>
            </select>
    ...
    <form v-else class="col-md-6" @submit.prevent="submit">
        <div class="mb-3">
            ...
            <select
                ...
                class="form-select"
                :class="{ 'is-invalid': groupForm.errors.course_id }"
            >
                <option value="" disabled>{{ t('admin.reseller.assignments.selectCourse') }}</option>
                <option v-for="course in courses.data" :key="course.id" :value="course.id">{{ course.title }}</option>
            </select>
        ...
        <div class="mb-3">
            ...
            <select
                ...
                class="form-select"
                :class="{ 'is-invalid': groupForm.errors.group_id }"
            >
