    ...
    <div class="d-flex flex-column min-vh-100">
        ...
        <div class="d-flex flex-grow-1">
            <aside class="bg-dark text-white p-3" style="width: 240px; flex-shrink: 0">
                <Link href="/" class="d-block text-white text-decoration-none fs-5 fw-semibold mb-4">
                    {{ $page.props.appName }}
                </Link>
                ...
                <ul class="nav nav-pills flex-column">
                    ...
                    <li class="nav-item">
                        <Link href="/admin/reseller/invoices" class="nav-link text-white">{{
                            t('layouts.reseller.invoices')
                        }}</Link>
                    </li>
                    <li class="nav-item">
