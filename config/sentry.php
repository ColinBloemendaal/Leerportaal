...
return [
    ...
    // Array-callable, not a closure: `php artisan config:cache` var_export()s
    // this file, and closures can't survive that. See CLAUDE.md §7 (PII must
    // never reach Sentry) -- this is defense-in-depth on top of
    // `send_default_pii => false` below.
    'before_send' => [SentryPiiRedactor::class, 'handle'],
