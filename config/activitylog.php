...
return [
     ...
     */
    // Defense in depth on top of each model's own HasAuditLog::auditLogExcept()
    // -- see CLAUDE.md §7, secrets must never land in a log, audit trail
    // included. Any future model reusing one of these column names is
    // covered automatically, without needing to remember to exclude it.
