...
final class CourseAssigned extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        return $this->brandedEnvelope(
            $this->reseller,
            $this->resellerTheme,
            trans('New course assigned: :course', ['course' => $this->course->title]),
        );
    }
    ...
    {
        return new Content(
            markdown: 'emails.assignments.assigned',
            with: [
